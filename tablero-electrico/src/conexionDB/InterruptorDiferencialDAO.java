...
public class InterruptorDiferencialDAO {
    ...
    public InterruptorDiferencial save(InterruptorDiferencial id) throws Exception {
        ...
        try {
            ...
            System.err.println("InterruptorDiferencialDAO.save: error de BD: " + e.getMessage());
            throw new Exception("No se pudo guardar el interruptor diferencial. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public InterruptorDiferencial update(InterruptorDiferencial id) throws Exception {
        ...
        try {
            ...
            System.err.println("InterruptorDiferencialDAO.update: error de BD: " + e.getMessage());
            throw new Exception("No se pudo actualizar el interruptor diferencial. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public boolean delete(int id) throws Exception {
        ...
        try {
            ...
            System.err.println("InterruptorDiferencialDAO.delete: error de BD: " + e.getMessage());
            throw new Exception("No se pudo eliminar el interruptor diferencial. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public List<InterruptorDiferencial> findAll() throws Exception {
        ...
        try {
            ...
            System.err.println("InterruptorDiferencialDAO.findAll: error de BD: " + e.getMessage());
    ...
    public InterruptorDiferencial findById(int id) throws Exception {
        ...
        try {
            ...
            System.err.println("InterruptorDiferencialDAO.findById: error de BD: " + e.getMessage());
            return null;
        }
        return null;
    }
