...
public class TableroPrincipalDAO {
    ...
    public TableroPrincipal save(TableroPrincipal tp) throws Exception {
        ...
        try {
            ...
            System.err.println("TableroPrincipalDAO.save: error de BD: " + e.getMessage());
            throw new Exception("No se pudo guardar el tablero. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public TableroPrincipal update(TableroPrincipal tp) throws Exception {
        ...
        try {
            ...
            System.err.println("TableroPrincipalDAO.update: error de BD: " + e.getMessage());
            throw new Exception("No se pudo actualizar el tablero. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public boolean delete(int id) throws Exception {
        ...
        try {
            ...
            System.err.println("TableroPrincipalDAO.delete: error de BD: " + e.getMessage());
            throw new Exception("No se pudo eliminar el tablero. Compruebe la conexión a la base de datos.", e);
        }
    }
    ...
    public List<TableroPrincipal> findAll() throws Exception {
        ...
        try {
            ...
            System.err.println("TableroPrincipalDAO.findAll: error de BD: " + e.getMessage());
    ...
    public TableroPrincipal findById(int id) throws Exception {
        ...
        try {
            ...
            System.err.println("TableroPrincipalDAO.findById: error de BD: " + e.getMessage());
            return null;
        }
        return null;
    }
    ...
    private TableroPrincipal reconstructTableroPrincipal(ResultSet rs) throws Exception {
        try {
            ...
            System.err.println("TableroPrincipalDAO.reconstructTableroPrincipal: error al reconstruir tablero: " + e.getMessage());
            throw e;
        }
    }
}
